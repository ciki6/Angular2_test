...
module.exports = function (env) {
  commonSetting.module.rules = helpers.replaceNewRules(commonSetting.module.rules, x => String(x.test) !== String(/\.ts$/), [{
    ...
    exclude: [/\.(spec|e2e)\.ts$/, helpers.root('src/polyfills.browser.ts'), helpers.root('src/vendor.browser.ts')]
  },
    {
      test: /\.ts$/,
      use: [
      ...
      include: [helpers.root('src/polyfills.browser.ts'), helpers.root('src/vendor.browser.ts')]
    }]);
